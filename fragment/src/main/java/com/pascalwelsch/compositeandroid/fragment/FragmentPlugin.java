...
public class FragmentPlugin extends AbstractPlugin<Fragment, FragmentDelegate> {
     ...
     *                   {@link Transition android.support.transition.Transition}.
     */
     ...
     * LayoutInflater or call {@link Fragment#getLayoutInflater()} when you want to
     * retrieve the current LayoutInflater.
     *
     * @hide
     * @deprecated Override {@link #onGetLayoutInflater(Bundle)} or call
     * {@link Fragment#getLayoutInflater()} instead of this method.
     */
     ...
     *                   must be an
     *                   {@link Transition android.transition.Transition}
     */
     ...
     * {@link androidx.fragment.app.FragmentTransaction#setCustomAnimations(int, int)} was called with
     * {@link Animator} resources instead of {@link Animation} resources, {@code nextAnim}
     * will be an animator resource.
     *
     * @param transit  The value set in {@link androidx.fragment.app.FragmentTransaction#setTransition(int)} or 0 if not
     *                 set.
     ...
     *                 {@link androidx.fragment.app.FragmentTransaction#setCustomAnimations(int, int)},
     *                 {@link androidx.fragment.app.FragmentTransaction#setCustomAnimations(int, int, int, int)}, or
     */
    ...
    /**
     * Called when the hidden state (as returned by {@link Fragment#isHidden()} of
     ...
     * both through attributes supplied here as well from {@link Fragment#getArguments()}:</p>
     *
     ...
     * is invoked for every call on {@link Fragment#requestPermissions(String[], int)}.
     * <p>
     ...
     * </p>
     *
     * @param requestCode  The request code passed in {@link Fragment#requestPermissions(String[], int)}.
     ...
     * or {@link androidx.fragment.app.FragmentManager#executePendingTransactions()} has been called.
     * <p>
     ...
     * if {@link Fragment#isStateSaved()} would return true.</p>
     */
     ...
     * {@link androidx.fragment.app.FragmentManager#saveFragmentInstanceState(Fragment)
     ...
     * across instances via {@link androidx.fragment.app.FragmentManager#putFragment
     ...
     * or {@link androidx.fragment.app.FragmentManager#executePendingTransactions()} to complete the FragmentTransaction.
     * If postponement was interrupted with {@link androidx.fragment.app.FragmentManager#executePendingTransactions()},
    ...
    void onActivityCreated(final CallVoid1<Bundle> superCall, @Nullable final Bundle savedInstanceState) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    Animation onCreateAnimation(final CallFun3<Animation, Integer, Boolean, Integer> superCall, final int transit,
    ...
    Animator onCreateAnimator(final CallFun3<Animator, Integer, Boolean, Integer> superCall, final int transit,
            final boolean enter, final int nextAnim) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void onInflate(final CallVoid3<Activity, AttributeSet, Bundle> superCall, final Activity activity,
            final AttributeSet attrs, final Bundle savedInstanceState) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void onViewStateRestored(final CallVoid1<Bundle> superCall, @Nullable final Bundle savedInstanceState) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void setReenterTransition(final CallVoid1<Object> superCall, @Nullable final Object transition) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void setSharedElementEnterTransition(final CallVoid1<Object> superCall, @Nullable final Object transition) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void setSharedElementReturnTransition(final CallVoid1<Object> superCall, @Nullable final Object transition) {
        synchronized (mSuperListeners) {
            mSuperListeners.push(superCall);
    ...
    void setTargetFragment(final CallVoid2<Fragment, Integer> superCall, @Nullable final Fragment fragment,
