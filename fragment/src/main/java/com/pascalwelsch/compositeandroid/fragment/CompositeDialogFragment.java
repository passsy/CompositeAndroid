...
public class CompositeDialogFragment extends DialogFragment implements ICompositeDialogFragment {
    ...
    @NonNull
    @Override
    public Dialog super_onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    @Override
    public void super_setStyle(int style, int theme) {
    ...
    @Override
    public void super_showNow(FragmentManager manager, String tag) {
