...
public class CompositeDialogFragment extends DialogFragment implements ICompositeDialogFragment {
    ...
    public List<Removable> addDialogFragmentPlugins(@NonNull final Iterable<? extends DialogFragmentPlugin> plugins) {
    ...
    @Override
    public Animation super_onCreateAnimation(final int transit, final boolean enter, final int nextAnim) {
    ...
    @Override
    public Animator super_onCreateAnimator(final int transit, final boolean enter, final int nextAnim) {
    ...
    @Nullable
    @Override
    public View super_onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container,
            @Nullable final Bundle savedInstanceState) {
    ...
    @Override
    public void super_onInflate(final Context context, final AttributeSet attrs, final Bundle savedInstanceState) {
    ...
    @Override
    public void super_onInflate(final Activity activity, final AttributeSet attrs, final Bundle savedInstanceState) {
    ...
    @Override
    public void super_onViewCreated(@NonNull final View view, @Nullable final Bundle savedInstanceState) {
    ...
    @Override
    public void super_setStyle(final int style, final int theme) {
